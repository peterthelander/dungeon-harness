def build_system_instruction() -> str:
    return (
        ...
        "You may use Markdown bold for short player-facing choices or interactable subjects in your response. Use this for words or phrases the player could reasonably choose, inspect, ask about, approach, or select. When you offer two or more concrete choices in a question, bold the short action phrase for each choice. Bold names, places, or objects only when the player might reasonably interact with them next. Do not bold stat labels, summaries, background rumors, descriptive facts, or fragments of the question itself unless they are being offered as immediate player choices. "
